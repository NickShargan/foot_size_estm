...
def get_foot_sizes_mm(ref_obj_corners, foot_points):
...
def get_foot_size_estm(img_path, gender='f', ref_obj='paper_letter',
    ...
    img_orig = np.array(results[0].orig_img)
    ...
    # img_vis = maks_vis(img_orig, ref_obj_corners, foot_points)
    ...
    print(f"foot size: US {feet_length_stnd['US']}; EU {feet_length_stnd['EU']};\
